...
@allure.story("Place an order by registering before checkout")
@allure.title("TC-015 — Place Order: Register Before Checkout")
@allure.severity(allure.severity_level.CRITICAL)
def test_order_register_before_checkout(driver: WebDriver):
    ...
    with allure.step("Open Signup / Login before adding products"):
